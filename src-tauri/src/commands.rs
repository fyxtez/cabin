...
#[tauri::command]
pub(crate) fn get_servers() -> Vec<ServerInfo> {
...
#[tauri::command]
pub(crate) async fn has_ssh_credentials(app: tauri::AppHandle, server_id: String) -> Result<bool, String> {
...
#[tauri::command]
pub(crate) async fn save_ssh_credentials(
    app: tauri::AppHandle,
    server_id: String,
...
#[tauri::command]
pub(crate) async fn get_services(app: tauri::AppHandle, server_id: String) -> Result<Vec<ServiceStatus>, String> {
    let server = server_by_id(&server_id)?;
    ...
    let units = services.iter().map(|service| crate::ssh::shell_quote(&service.unit)).collect::<Vec<_>>().join(" ");
...
pub(crate) async fn get_logs(
    ...
    let command = format!(
        ...
        crate::ssh::shell_quote(&format!("/opt/{service_name}")),
